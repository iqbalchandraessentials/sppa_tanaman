<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class="header nav-small-cap text-uppercase">Dashboard</li>
            ...
            <li class="pt-3 {{ Request::segment(1) === '/' ? 'active' : '' }}">
                <a href="{{ url('/') }}">
                    <i class="ti-list"></i>
                    <span>SPPA GTI</span>
                </a>
            </li>
            <li class="header nav-small-cap text-uppercase">Claim</li>
            <li class="pt-3 {{ Request::segment(1) === 'claim' ? 'active' : '' }}">
                <a href="{{ url('claim') }}">
                    <i class="ti-list"></i>
                    <span>Claim</span>
                </a>
